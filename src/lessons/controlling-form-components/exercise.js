 ...
 * consumers, or conversely, track its value state internally, so that the selected
 * button option continues to change even if nothing is controlling its valuee.
 **/
