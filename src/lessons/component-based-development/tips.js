  ...
  <React.Fragment>
    <div className="m-1">
      <div className="text-justify">
        When trying to decide where to break apart a large component into subcomponents, consider entire blocks that look similar to each other as an obvious starting point. Those can be pulled out and turned into a component of their own, and then embedded back into the original view.
      </div>
      <div className="mt-3 text-justify">
        Don't stop there, though. Look for areas where a data structure is being iterated over in order to generate a list of nodes. The contents of that loop are typically also ideal candidates to be turned into their own component. Look for render functions of any kind (e.g. <Highlight>renderListItem</Highlight>, <Highlight>renderUserAvatar</Highlight>, etc). If a component has already opted to break its view apart into separate functions, those functions likely already house what can easily be turned into separate subcomponents.
      </div>
      <div className="mt-3 text-justify">
