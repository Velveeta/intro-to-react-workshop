...
const StateVsPropsVsContextTips = () => (
  <React.Fragment>
    <div className="m-1">
      ...
      <div className="mt-3 text-justify">
        Always try to be mindful of the method you're using to pass data from one segment of your application to another. Data should always be propagated downwards via props or context, and updates should propagate their way upwards via setter-type callbacks.
      </div>
    </div>
  </React.Fragment>
);
