  ...
  <React.Fragment>
    <div className="m-1">
      <div className="text-justify">
        Keep your unit tests simple. They should test a single facet of a single feature. If you have a prop that causes something to conditionally render, test both cases of that, with and without the appropriate value. If you have a condition that should throw an error, try to create that condition in the test environment, and ensure that the error is thrown. If you're expecting certain verbiage to be present, or certain elements to be present, create the condition that should manifest those effects, and assert that they're correct. Unit tests are simple to write, and typically quick to execute. These should make up the bulk of your testing library.
      </div>
